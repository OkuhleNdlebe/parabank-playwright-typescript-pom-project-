...
export class TransferFundsPage {
    ...
    readonly transactionCompleteHeading: Locator;
    ...
    constructor(page: Page) {
        ...
        this.transactionCompleteHeading = page.locator('#rightPanel').getByRole('heading', { name: 'Transfer Complete!' });
    ...
    async goTo() {
        ...
        await expect(this.transactionCompleteHeading).toBeVisible();
    }
    ...
    async verifyTransferSuccess(amount: string, fromAccountId: string, toAccountId: string) {
        ...
        await expect(this.transferSuccessMessage).toContainText(`$${amount} has been transferred from account ${fromAccountId} to account ${toAccountId}`);
    }
